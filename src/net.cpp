...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Monexcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"monexcointools.com", "dnsseed.monexcointools.com"},
    {"monexcoinpool.org", "dnsseed.monexcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"monexcointools.com", "testnet-seed.monexcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Monexcoin is probably already running."), addrBind.ToString().c_str());
        else
